...
def find_top_recommendations():
    ...
    for ticker in top_50_stocks:
        try:
            ...
            if current_price is None or predicted_price is None:
                st.warning(f"Prediction failed for ticker '{ticker}', skipping.")
                continue
    ...
    # Sort results by the magnitude of movement
    try:
    ...
    if not results:
        ...
        for ticker, current_price, predicted_price, movement in results:
            try:
